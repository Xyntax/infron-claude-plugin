...
|---|---|---|---|
| `infron__image` | Generate an image and save the file | `google/nano-banana-pro-text-to-image` | ~$0.15/image |
| `infron__video` | Generate a video (async, auto-polled) | `google/veo3.1/text-to-video` | ~$0.40/sec ($3.20 for 8s) |
